<template>
  <view class='page float-layout-page'>
    ...
    <view class='doc-body'>
      ...
      <!-- 最大高度 -->
      <view class='panel'>
        <view class='panel__title'>最大高度</view>
        <view class='panel__content'>
          <view class='example-item'>
            <AtButton :onClick="handleClick.bind(this, 2)">
              打开 Float Layout
            </AtButton>
          </view>
        </view>
      ...
      <view class='panel'>
        <view class='panel__title'>监听事件</view>
        <view class='panel__content'>
          <view class='example-item'>
            <AtButton :onClick="handleClick.bind(this, 3)">
              打开 Float Layout
            </AtButton>
          </view>
        </view>
    ...
    <AtFloatLayout
      :isOpened="isOpened1"
      :onClose="handleClose.bind(this, '1')"
    >
