<template>
  <view class="page">
    ...
    <view class="doc-body">
      <!-- 基础用法 -->
      <view class="panel">
        <view class="panel__title">等宽标签栏</view>
      ...
      <view class="panel">
        <view class="panel__title">滚动标签栏</view>
        <view class="panel__content">
          <AtTabs
            :swipeable="false"
            scroll
      ...
      <view class="panel">
        <view class="panel__title">滑动切换内容</view>
        <view class="panel__content">
          <AtTabs
            :current="current3"
            :tabList="tabList1"
            :onClick="handleClick.bind(this, 'current3')"
          >
      ...
      <view class="panel">
        <view class="panel__title">垂直模式</view>
        <view class="panel__content">
          <AtTabs
            height="200px"
            scroll
            ...
            :current="current4"
            :tabList="tabList2"
            :onClick="handleClick.bind(this, 'current4')"
          >
      ...
      <view class="panel">
        <view class="panel__title">禁止内容切换动画</view>
        <view class="panel__content">
          <AtTabs
            :current="current5"
            :animated="false"
            :tabList="tabList1"
            :onClick="handleClick.bind(this, 'current5')"
          >
